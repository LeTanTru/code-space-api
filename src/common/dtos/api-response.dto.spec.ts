...
describe('API Response DTOs', () => {
  describe('SingleResponseDto', () => {
    it('should correctly format single item response', () => {
  ...
  describe('ListResponseDto', () => {
    it('should correctly format list items with pagination metadata', () => {
  ...
  describe('MutateResponseDto', () => {
    it('should correctly format mutation response with data payload', () => {
  ...
  describe('NoDataResponseDto', () => {
    it('should correctly format no-data mutation response', () => {
